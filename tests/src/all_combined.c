...
int main(void)
{
	...
	renderable room = modelLoad("viking_room.obj", &params, 1, 0, 0);
	renderable room_indexed = modelLoad("viking_room.obj", &params, 1, 1, 0);
	renderable room_normals = modelLoad("viking_room.obj", &params, 1, 0, 1);
	renderable room_indexed_normals = modelLoad("viking_room.obj", &params, 1, 1, 1);
	params.compactMVP = 1;
	params.vertShaderName = "texture_v3.vert.spv";
	renderable room_compact_mvp = modelLoad("viking_room.obj", &params, 1, 1, 0);
	params.sendMVPAsPushConstant = 1;
	params.vertShaderName = "texture_v4.vert.spv";
	params.fragShaderName = "texture_v3.frag.spv";
	renderable room_push_cst_mvp = modelLoad("viking_room.obj", &params, 1, 1, 0);
	...
	renderable room_sbbo = modelLoad("viking_room.obj", &params, 1, 1, 0);
	params.vertShaderName = "texture_v4.vert.spv";
	params.fragShaderName = "texture_v3.frag.spv";
	params.sendMVPAsPushConstant = 1;
	params.sendMVPAsStorageBuffer = 0;
	params.textureName = "holes.png";
	renderable sphere_holes = modelLoad("sphere.obj", &params, 1, 1, 0);
	params.textureName = "this file doesn't exist";
	renderable sphere_missing_texture = modelLoad("sphere.obj", &params, 1, 1, 0);
	params.sendMVPAsPushConstant = 0;
	params.compactMVP = 0;
